    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        for (int tier = GTValues.LV; tier <= GTValues.UV; tier++) {
            ...
            ASSEMBLER_RECIPES
                .recipeBuilder(
                    SFTCore.id(
                        GTValues.VN[tier].toLowerCase(Locale.ROOT) + "_256a_wireless_laser_target_hatch"
                    )
                )
                .inputItems(hatch)
        ...
        for (int tier = GTValues.LV; tier <= GTValues.UV; tier++) {
            ...
            ASSEMBLER_RECIPES
                .recipeBuilder(
                    SFTCore.id(
                        GTValues.VN[tier].toLowerCase(Locale.ROOT) + "_256a_wireless_laser_source_hatch"
                    )
                )
                .inputItems(hatch)
                .inputItems(GTCraftingComponents.SENSOR.get(tier), 2)
        ...
        for (int tier = GTValues.LV; tier <= GTValues.UV; tier++) {
            ...
            ASSEMBLER_RECIPES
                .recipeBuilder(
                    SFTCore.id(
                        GTValues.VN[tier].toLowerCase(Locale.ROOT) + "_1024a_wireless_laser_target_hatch"
                    )
                )
                .inputItems(hatch)
        ...
        for (int tier = GTValues.LV; tier <= GTValues.UV; tier++) {
            ...
            ASSEMBLER_RECIPES
                .recipeBuilder(
                    SFTCore.id(
                        GTValues.VN[tier].toLowerCase(Locale.ROOT) + "_1024a_wireless_laser_source_hatch"
                    )
                )
                .inputItems(hatch)
                .inputItems(GTCraftingComponents.SENSOR.get(tier), 4)
        ...
        for (int tier = GTValues.LV; tier <= GTValues.UV; tier++) {
            ...
            ASSEMBLER_RECIPES
                .recipeBuilder(
                    SFTCore.id(
                        GTValues.VN[tier].toLowerCase(Locale.ROOT) + "_4096a_wireless_laser_target_hatch"
                    )
                )
                .inputItems(hatch)
        ...
        for (int tier = GTValues.LV; tier <= GTValues.UV; tier++) {
            ...
            ASSEMBLER_RECIPES
                .recipeBuilder(
                    SFTCore.id(
                        GTValues.VN[tier].toLowerCase(Locale.ROOT) + "_4096a_wireless_laser_source_hatch"
                    )
                )
                .inputItems(hatch)
                .inputItems(GTCraftingComponents.SENSOR.get(tier), 8)
