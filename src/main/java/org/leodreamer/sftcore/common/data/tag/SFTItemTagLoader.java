...
public final class SFTItemTagLoader {
    ...
    public static void init(RegistrateItemTagsProvider provider) {
        provider.addTag(Tags.Items.DYES_YELLOW).add(Items.GOLD_INGOT);
        provider.addTag(Tags.Items.DYES_BLACK).add(Items.COAL);
        provider.addTag(Tags.Items.DYES_BLUE).add(Items.LAPIS_LAZULI);
        provider.addTag(Tags.Items.DYES_LIME).add(Items.EMERALD);
        provider.addTag(Tags.Items.DYES_RED).add(Items.REDSTONE);
        provider.addTag(Tags.Items.DYES_ORANGE).add(Items.COPPER_INGOT);
