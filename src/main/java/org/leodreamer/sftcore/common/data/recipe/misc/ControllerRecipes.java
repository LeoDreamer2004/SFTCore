...
public final class ControllerRecipes {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        ASSEMBLER_RECIPES
            ...
            .inputItems(MekanismBlocks.getFactory(FactoryTier.ULTIMATE, FactoryType.INFUSING).getSecondary())
            .inputItems(MekanismBlocks.getFactory(FactoryTier.ULTIMATE, FactoryType.ENRICHING).getSecondary())
            .inputItems(MekanismBlocks.getFactory(FactoryTier.ULTIMATE, FactoryType.SMELTING).getSecondary())
            .inputItems(MekanismBlocks.PRESSURIZED_REACTION_CHAMBER.getSecondary())
            .inputItems(MekanismBlocks.CHEMICAL_DISSOLUTION_CHAMBER.getSecondary())
            .inputItems(MekanismBlocks.ELECTROLYTIC_SEPARATOR.getSecondary())
            .inputItems(MekanismBlocks.SOLAR_NEUTRON_ACTIVATOR.getSecondary())
            .inputItems(MekanismBlocks.ISOTOPIC_CENTRIFUGE.getSecondary())
            .inputItems(MekanismBlocks.ROTARY_CONDENSENTRATOR.getSecondary())
