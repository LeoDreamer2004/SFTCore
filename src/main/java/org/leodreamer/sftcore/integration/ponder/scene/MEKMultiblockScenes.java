...
public class MEKMultiblockScenes {
    ...
    public static void turbine(SFTSceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.overlay()
            ...
            .colored(PonderPalette.BLUE)
            .text(
                "Place Electromagnetic Coils directly above the Rotation Complex, connected and at least half the number of rotors"
            )
        ...
        scene.overlay()
            ...
            .colored(PonderPalette.GREEN)
            .text(
                "Replace Turbine Casing around and above the Pressure Dispersers with as many Turbine Vanes as possible"
            )
        ...
        scene.text(
            60,
            "If needed, you can also place several Saturated Condensers in the upper layer to recycle water"
        );
        scene.idle(60);

        scene.world().setBlocks(sel.fromTo(2, 8, 2, 3, 8, 6), Blocks.AIR.defaultBlockState(), true);
        scene.idle(10);
        scene.world().setBlocks(sel.fromTo(5, 8, 2, 6, 8, 6), Blocks.AIR.defaultBlockState(), true);
        scene.idle(40);
    ...
    public static void fissionReactor(SFTSceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.text(
            70,
            "Use Fission Reactor Casing to build a cuboid frame with length 3~18 blocks, width 3~18 blocks, and height 4~18 blocks"
        );
        scene.idle(80);
        ...
        scene.addKeyframe();
        scene.text(
            70, "Then fill all faces of the cuboid with Reactor Glass or Fission Reactor Casing"
        );
        scene.idle(85);
        scene.addKeyframe();
    ...
    public static void sps(SFTSceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.overlay()
            ...
            .colored(PonderPalette.BLUE)
            .text(
                "Use Supercritical Phase Shifter Casing and Structure Glass to build the shape like this..."
            )
        ...
        scene.overlay()
            ...
            .colored(PonderPalette.BLUE)
            .text(
                "Place the Supercritical Phase Shifter Port here and supply it with a large amount of power"
            )
        ...
        scene.overlay()
            ...
            .colored(PonderPalette.BLUE)
            .text(
                "Replace several structure glass on other sides with Supercritical Phase Shifter Ports"
            )
