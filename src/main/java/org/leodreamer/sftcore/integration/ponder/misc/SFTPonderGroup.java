...
public enum SFTPonderGroup {
    ...
    MOLECULAR_ASSEMBLER(
        ASSEMBLER_MATRIX.merge(AEBlocks.MOLECULAR_ASSEMBLER, EPPItemAndBlock.EX_ASSEMBLER)
    ),
    ...
    IMPORT_BUS(AEParts.IMPORT_BUS, EPPItemAndBlock.EX_IMPORT_BUS),
    ...
    ANNIHILATION_PLANE(AEParts.ANNIHILATION_PLANE),

    FORMATION_PLANE(AEParts.FORMATION_PLANE, EPPItemAndBlock.ACTIVE_FORMATION_PLANE),

    QUANTUM_BRIDGE(AEBlocks.QUANTUM_RING, AEBlocks.QUANTUM_LINK),

    IO_PORT(AEBlocks.IO_PORT, EPPItemAndBlock.EX_IO_PORT),
