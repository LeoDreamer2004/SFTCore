...
public class AENetworkScenes {
    ...
    public static void controller(SFTSceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.world().setBlocks(sel.position(8, 1, 1), AEBlocks.CONTROLLER.block().defaultBlockState());
        scene.idle(20);
    ...
    public static void quantumBridge(SFTSceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.overlay().showOutline(PonderPalette.GREEN, new Object(), sel.position(1, 1, 0), 60);
        ...
        scene.rotateCameraY(180);
        scene.idle(30);
        scene.overlay().showControls(vec.of(1.5, 2.5, 0), Pointing.LEFT, 40).withItem(singularity);
        scene.idle(60);
