...
public class AEAutomationScenes {
    ...
    public static void craftingSystem(SFTSceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.overlay().showText(40)
                .text("To set up an automated crafting system...");
        scene.idle(60);
        scene.world().showSection(sel.fromTo(0, 1, 1, 1, 1, 3), Direction.DOWN);
        scene.idle(20);
        scene.overlay().showText(40)
                .text("You need a Crafting CPU multiblock")
        ...
        scene.idle(20);
        scene.overlay().showText(40)
                .text("as well as a Pattern Provider and an Output Destination")
                .pointAt(vec.of(4.5, 2, 1));
        scene.overlay().showOutline(PonderPalette.GREEN, new Object(),
                sel.fromTo(4, 1, 0, 4, 1, 1), 40);
        scene.idle(80);
        scene.overlay().showText(80)
                .text("By writing patterns with the Pattern Encoding Terminal and placing them into the Pattern Provider, you can start ordering crafts")
